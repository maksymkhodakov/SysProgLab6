...
---
### Таблиця порівняння
| Таблиця порівняння                | Не оптимізованого        | Оптимізованого           | Різниця    | Різниця у % |
|-----------------------------------|--------------------------|--------------------------|------------|-------------|
| Час виконання                     | ~50 секунд               | ~40 секунд               | ~10 секунд | 20%         |
| perf stat user час                | 2,157220000 seconds user | 0,592626000 seconds user | 1.564594 s | 72.53%      |
| perf stat sys час                 | 0,604571000 seconds sys  | 0,581785000 seconds sys  | 0.022786 s | 3.77%       |
| perf report (Overhead фунції gcd) | 40,57%                   | 38,70%                   | 1.87%      | 4.61%       |
| likwid powermeter  (енеговитрати) | 10.203 Watts             | 8.203 Watts              | 2 Watts    | 19.60%      |
